package ro.go.adrhc.springbootkstreamstutorial.adapters.topologies.reports.transformers;
...
public abstract class AbstractTotalSpentValueTransformerSupp<T> implements ValueTransformerSupplier<Command, List<T>> {
	...
	public AbstractTotalSpentValueTransformerSupp(String storeName) {this.storeName = storeName;}
